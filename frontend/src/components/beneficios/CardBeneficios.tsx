  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-6">
      {beneficios.map((ben, index) => (
        <motion.div
          key={ben.id}
          className="relative flex flex-col justify-between rounded-2xl p-6 shadow-brand-lg border hover:border-pink-200 hover:shadow-[0_0_15px_#f472b6] transition-all duration-300 cursor-pointer hover:scale-[1.03]"
          initial="hidden"
          whileInView="visible"
